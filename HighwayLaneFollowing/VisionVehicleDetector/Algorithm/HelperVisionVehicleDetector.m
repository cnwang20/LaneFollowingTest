    ...
    methods(Access = protected)
        ...
        function setupImpl(obj)
            ...
            elseif(obj.Detector == VehicleDetector.YOLOv2)
                ...
                obj.VehicleDetectionThreshold = 0.4;
        ...
        function sensorOut =  detectVehicles(obj,frame)
            ...
            elseif(obj.Detector == VehicleDetector.YOLOv2)
                [bboxes,scores,~] = detect(obj.YOLOv2Obj, frame,ROI,'Threshold',obj.VehicleDetectionThreshold);
                [bboxes,scores] = selectStrongestBbox(bboxes,scores,"RatioType","Min","OverlapThreshold",0.4);
            end
