...
assignin('base','numRadarDetections', 36);  % Maximum number of radar detections
assignin('base','numObjectDetections', 10); % Maximum number of object detections
...
assignin('base', 'assigThresh',  100);        % Tracker assignment threshold
...
assignin('base', 'numTracks',     36);        % Maximum number of tracks
assignin('base', 'numSensors',     2);        % Maximum number of sensors
assignin('base', 'TimeDataType', 'single');   % Time input port data type
